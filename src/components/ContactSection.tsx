      ...
      <div className="container max-w-6xl px-5 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div className="grid gap-4 lg:gap-6">
              {contactItems.map((item, i) => (
                <motion.div 
                  ...
                  className="bg-card border border-white/5 rounded-[1.5rem] lg:rounded-[2rem] p-6 lg:p-8 shadow-sm group hover:border-primary/20 transition-all duration-300"
                >
                  <div className="flex items-start gap-4 lg:gap-6">
                    <div className="w-12 h-12 lg:w-14 lg:h-14 rounded-xl lg:rounded-2xl bg-primary/10 flex items-center justify-center flex-shrink-0 group-hover:bg-primary group-hover:text-primary-foreground transition-all">
                      <item.icon className="w-6 h-6 lg:w-7 lg:h-7" />
                    </div>
                    <div>
                      <h3 className="font-bold text-lg lg:text-xl text-white mb-1">{item.title}</h3>
                      <p className="text-foreground/60 text-sm lg:text-base leading-relaxed">{item.desc}</p>
                    </div>
                  </div>
                </motion.div>
              ))}
          ...
          >
            ...
            <div className="bg-card border border-white/10 rounded-[2rem] lg:rounded-[2.5rem] p-6 lg:p-10 shadow-elevated transition-all hover:border-primary/20">
              <h3 className="text-2xl lg:text-3xl font-bold text-white mb-2">Send a Question</h3>
              <p className="text-foreground/50 text-sm lg:text-base mb-6 lg:mb-8">Fill this form and we will call you back soon.</p>
              ...
              <form className="space-y-5" onSubmit={handleSubmit}>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-5">
                    <div className="space-y-2">
                       ...
                       <input 
                         ...
                         className="w-full h-12 lg:h-14 bg-white/5 border border-white/10 rounded-xl lg:rounded-2xl px-6 focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary/40 transition-all text-white text-sm placeholder:text-white/20" 
                       />
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-5">
                    <div className="space-y-2">
                      ...
                      <select 
                        ...
                        className="w-full h-12 lg:h-14 bg-white/5 border border-white/10 rounded-xl lg:rounded-2xl px-6 focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary/40 transition-all text-white appearance-none cursor-pointer text-sm"
                      >
                ...
                <Button type="submit" className="w-full h-14 lg:h-16 rounded-xl lg:rounded-2xl bg-primary text-primary-foreground font-extrabold text-lg gap-3 hover:bg-primary/90 transition-all shadow-elevated group">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8 items-stretch justify-center">
              <a href="tel:+919725763394" className="w-full sm:w-auto">
                <Button className="w-full bg-primary text-primary-foreground hover:bg-primary/90 gap-3 h-14 px-8 rounded-xl lg:rounded-2xl font-bold text-lg shadow-elevated transition-all">
                  <Phone className="w-5 h-5" /> Call Now
                </Button>
              </a>
              <a href="https://wa.me/919725763394" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                <Button variant="outline" className="w-full border-white/10 glass-morphism text-white gap-3 h-14 px-8 rounded-xl lg:rounded-2xl font-bold text-lg hover:bg-white/10 transition-all">
